...
public class HRegionServer implements HRegionInterface, HBaseRPCErrorHandler,
  ...
  // controller
  private NewLowerLimitController llc;
  ...
  private void initializeThreads() throws IOException {
    llc = new NewLowerLimitController(this, getConfiguration());
    //Thread controllerThd = new Thread(llc);
    //controllerThd.start();

    // Cache flushing thread.
    this.cacheFlusher = new MemStoreFlusher(conf, this, llc);
